    ...
    <div style={{ fontFamily: '"Montserrat', textShadow: "rgba(0, 0, 0, 0.4) 0px 4px 5px" }}>
      ...
      <div className="min-h-screen bg-[#142B2B] justify-around text-white px-10 py-16 flex flex-col lg:flex-row items-start " >
        ...
        <div className="lg:w-1/2   mt-10 lg:mt-0">
          <h2 className="text-4xl font-light text-[#c08d31]">SUCCESSFUL PROJECTS</h2>
          <ul className="mt-6 text-3xl space-y-4">
            {[
              "The Golden Hive",
              "The Jasmil Heights",
              "The Jasmil Luxury",
              ...
              <li key={index} className="text-3xl font-semibold text-white">
                {project}
                {project === "The Urban Oasis" ? (
                  <p className="text-[#c08d31] text-sm">GREATER ACCRA, GHANA</p>
                ) : (
                  <p className="text-[#c08d31] text-sm">Heart of Accra, Ghana</p>
                )}
              </li>
            ))}
          </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl">
          ...
          <div className="relative">
            <img
              src={Aminities}
              alt="Vision"
              className="w-full h-[58vh] rounded-lg"
            />
          </div>
          <div className="flex flex-col justify-center relative text-[#142B2B]">
            ...
            <p className=" text-2xl text-[#142B2B]">
              Valor Vista is a master-planned residential community redefining
              modern living in Ghana.Nestled in the serene landscape of
              Kwabenya Greater Accra,this premium project blends luxury,comfort, and natural elegance.
              <p></p>
              <br />
          ...
          <div className="flex flex-col justify-center relative text-[#142B2B]">
            ...
            <p className="text-2xl  text-[#142B2B]">
              To become a leading name in Ghana’s modern residential development sector
              ,offering distinctive and elevated living experiences through thoughtfully designed,
              sustainable communities like Valor Vista.
              <p></p> <br />
